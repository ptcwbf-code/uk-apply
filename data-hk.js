...
const HKSCHOOLS = [
  { key: 'hku',    zh: '港大',   en: 'University of Hong Kong',        group: '港八', mark: '港大', color: '#25603c', checked: '2026-09', fee: { label: '非本地生学费', amt: 'HK$224,000–249,000', year: '2026-27', note: '非 STEM 学院 / STEM 学院（含 STEM fee）两档', url: 'https://admissions.hku.hk/fees-and-scholarships/fees' }},
  { key: 'cuhk',   zh: '港中文', en: 'Chinese University of Hong Kong', group: '港八', mark: '中大', color: '#6c3a74', checked: '2026-09', fee: { label: '非本地生学费', amt: 'HK$214,000', year: '2026-27', url: 'https://admission.cuhk.edu.hk/fees-financing-your-studies/fees/' }},
  { key: 'hkust',  zh: '港科大', en: 'Hong Kong University of Science & Tech', group: '港八', mark: '科大', color: '#1f5aa8', checked: '2026-09', fee: { label: '非本地生学费', amt: 'HK$260,000', year: '2027/28', url: 'https://join.hkust.edu.hk/fees-and-scholarships' }},
  { key: 'cityu',  zh: '城大',   en: 'City University of Hong Kong',    group: '港八', mark: '城大', color: '#b02a30', checked: '2026-09', fee: { label: '非本地生学费', amt: 'HK$190,000', year: '2026-27', note: '兽医学 BVM 为 HK$392,000', url: 'https://www.cityu.edu.hk/admo/fees-and-scholarships?kind=nonlocal' }},
  { key: 'polyu',  zh: '理大',   en: 'Hong Kong Polytechnic University', group: '港八', mark: '理大', color: '#9b2f5f', checked: '2026-09', fee: { label: '非本地生学费', amt: 'HK$200,000', year: '2026/27', url: 'https://www.polyu.edu.hk/study/ug/fees-and-scholarships/fees' }},
  { key: 'hkbu',   zh: '浸会',   en: 'Hong Kong Baptist University',   group: '港八', mark: '浸会', color: '#a15c11', checked: '2026-09', fee: { label: '非本地生学费', amt: 'HK$190,000', year: '2026/27', url: 'https://admissions.hkbu.edu.hk/fees-and-scholarships.html' }},
  { key: 'eduhk',  zh: '教育',   en: 'Education University of Hong Kong', group: '港八', mark: '教大', color: '#0f7a6c', checked: '2026-09', fee: { label: '非本地生学费', amt: 'HK$180,000', year: '2026/27', url: 'https://www.apply.eduhk.hk/ug/fees' }},
  { key: 'lingnan', zh: '岭南',  en: 'Lingnan University',             group: '港八', mark: '岭南', color: '#8c1d40', checked: '2026-09', fee: { label: '非本地生学费', amt: 'HK$175,000', year: '2026-27', url: 'https://www.ln.edu.hk/admissions/ug/your-future-begins-now-apply/fees-and-scholarships' }}
];
...
const HKPROGRAMS = [
  ...
  { school: 'hku',
    dirs: ['edu', 'arts'],
    zh: '文学士及教育学士（语文教育）',
    en: 'Bachelor of Arts and Bachelor of Education (Language Education)',
    degree: 'JS6066 · 5 年制',
    alevel: '3A',
    ib: '32/45',
    alevelNote: '',
    test: '面试（入围）',
    offer: 'lower',
    note: '文学院与教育学院合办五年制双学位；分英文（JS6066）与中文（JS6080）两方向；建议随申请提交英文个人陈述',
    url: 'https://admissions.hku.hk/programmes/undergraduate-programmes/bachelor-of-arts-and-bachelor-of-education-language-education' },

  { school: 'hku',
    dirs: ['edu'],
    zh: '教育学士（幼儿教育及特殊教育）',
    en: 'Bachelor of Education in Early Childhood Education and Special Education',
    degree: 'JS6092 · 5 年制',
    alevel: '3A',
    ib: '32/45',
    alevelNote: '',
    test: '面试（入围）',
    offer: 'lower',
    note: '教育学院；幼儿教育与特殊教育双专业，培养幼教及特殊教育师资；要求英语（口语及书写）流利',
    url: 'https://admissions.hku.hk/programmes/undergraduate-programmes/bachelor-of-education-early-childhood-education-and-special' },

  { school: 'hku',
    dirs: ['edu'],
    zh: '言语病理学（理学士）',
    en: 'Bachelor of Science in Speech-Language Pathology',
    degree: 'JS6157 · 5 年制',
    alevel: '3A',
    ib: '37/45',
    alevelNote: '',
    test: '面试（入围）',
    offer: 'lower',
    note: '教育学院；言语治疗专业，培养言语及吞咽障碍评估与治疗人才；要求中英（粤语）双语流利',
    url: 'https://admissions.hku.hk/programmes/undergraduate-programmes/bachelor-of-science-speech-language-pathology' },

  { school: 'hku',
    dirs: ['arts'],
    zh: '文学士（人文与数码科技）',
    en: 'Bachelor of Arts in Humanities and Digital Technologies',
    degree: 'JS6286 · 4 年制',
    alevel: '3A',
    ib: '32/45',
    alevelNote: '',
    test: '面试（入围）',
    offer: 'lower',
    note: '文学院；人文与数码科技跨学科，结合人文学科与数据、数码技术训练',
    url: 'https://admissions.hku.hk/programmes/undergraduate-programmes/bachelor-of-arts-humanities-and-digital-technologies' },

  { school: 'hku',
    dirs: ['arts', 'social'],
    zh: '文学士及法学士',
    en: 'Bachelor of Arts and Bachelor of Laws',
    degree: 'JS6078 · 5 年制',
    alevel: '3A*',
    ib: '41/45',
    alevelNote: '',
    test: '面试（入围）',
    offer: 'lower',
    note: '文学院与法律学院合办五年制双学位；优先考虑第一志愿申请人',
    url: 'https://admissions.hku.hk/programmes/undergraduate-programmes/bachelor-of-arts-and-bachelor-of-laws' },

  { school: 'hku',
    dirs: ['social'],
    zh: '社会科学学士（政府与法律）及法学士',
    en: 'Bachelor of Social Sciences (Government and Laws) and Bachelor of Laws',
    degree: 'JS6810 · 5 年制',
    alevel: '3A*',
    ib: '40/45',
    alevelNote: '',
    test: '面试（入围）',
    offer: 'lower',
    note: '社会科学学院与法律学院合办五年制双学位；非本地申请人须通过英文评估（英文测试／校内成绩及／或面试）',
    url: 'https://admissions.hku.hk/programmes/undergraduate-programmes/bachelor-of-social-sciences-government-and-laws-and-bachelor-of' },
  ...
  { school: 'cuhk',
    ...
    test: '',
    offer: 'ref',
    note: '文学院历史系；设历史与英文、历史与日本研究双主修',
    url: 'https://admission.cuhk.edu.hk/programme/histn/' },
  ...
  { school: 'cuhk',
    ...
    offer: 'ref',
    note: '文学院哲学系',
    url: 'https://admission.cuhk.edu.hk/programme/philn/' },
  ...
  { school: 'cuhk',
    ...
    offer: 'ref',
    note: '文学院语言学及现代语言系',
    url: 'https://admission.cuhk.edu.hk/programme/lingn/' },
  ...
  { school: 'cuhk',
    ...
    test: '',
    offer: 'ref',
    note: '文学院日本研究学系；设历史与日本研究双主修',
    qs: ['modern-languages'],
    url: 'https://admission.cuhk.edu.hk/programme/jaspn/' },
  ...
  { school: 'cuhk',
    ...
    test: '面试',
    offer: 'ref',
    note: '文学院音乐系；须提交演奏／演唱录像及笔试，主修乐器或声乐宜达 ABRSM／Trinity 八级',
    url: 'https://admission.cuhk.edu.hk/programme/muscn/' },
  ...
  { school: 'cuhk',
    ...
    offer: 'ref',
    note: '社会科学院社会学系',
    url: 'https://admission.cuhk.edu.hk/programme/socin/' },
  ...
  { school: 'cuhk',
    ...
    test: '',
    offer: 'ref',
    note: '社会科学院社会工作学系；毕业可申请注册为社会工作者',
    url: 'https://admission.cuhk.edu.hk/programme/sowkn/' },

  { school: 'cuhk',
    dirs: ['edu', 'arts'],
    zh: '文学士（英国语文研究）及教育学士（英国语文教育）',
    en: 'English Studies (BA) and English Language Education (BEd)',
    degree: 'JS4343 · 5 年制',
    alevel: 'ABB–AAB',
    ib: '33–35',
    alevelNote: '',
    test: '',
    offer: 'ref',
    note: '教育学院；文学士＋教育学士双学位，5 年制',
    url: 'https://admission.cuhk.edu.hk/programme/eledn/' },
  ...
  { school: 'cityu',
    ...
    test: '面试（入围）',
    offer: 'ger',
    note: '人文社会科学院社会及行为科学系；面试表现与选科次序为重要考虑；毕业可申请注册为社会工作者',
    url: 'https://www.cityu.edu.hk/admo/programmes/bsocsc-social-work' },

  { school: 'cityu',
    dirs: ['arts'],
    zh: '文学士（语言学及语言应用）',
    en: 'BA Linguistics and Language Applications',
    degree: 'JS1109 · 4 年制',
    alevel: '3 AL ≥ E',
    ib: '文凭（未列分数）',
    alevelNote: '',
    test: '',
    offer: 'ger',
    note: '人文社会科学院语言学及翻译系；方向含普通语言学 / 计算语言学 / 语料库语言学 / 实验语言学 / 语言科技及应用',
    url: 'https://www.cityu.edu.hk/admo/programmes/ba-linguistics-and-language-applications' },

  { school: 'cityu',
    dirs: ['social'],
    zh: '社会科学学士（国际关系及全球事务）',
    en: 'BSocSc International Relations and Global Affairs',
    degree: 'JS1102 · 4 年制',
    alevel: '3 AL ≥ E',
    ib: '文凭（未列分数）',
    alevelNote: '',
    test: '',
    offer: 'ger',
    note: '人文社会科学院公共及国际事务学系；前称亚洲及国际研究；专修：亚洲研究 / 国际研究 / 发展研究',
    url: 'https://www.cityu.edu.hk/admo/programmes/bsocsc-international-relations-and-global-affairs' },

  { school: 'cityu',
    dirs: ['social'],
    zh: '社会科学学士（犯罪科学）',
    en: 'BSocSc Crime Science',
    degree: 'JS1111 · 4 年制',
    alevel: '3 AL ≥ E',
    ib: '文凭（未列分数）',
    alevelNote: '',
    test: '',
    offer: 'ger',
    note: '人文社会科学院社会及行为科学系；方向：犯罪预防 / 保安实务 / 全球警务 / 犯罪分析 / 网络与未来犯罪',
    url: 'https://www.cityu.edu.hk/admo/programmes/bsocsc-crime-science' },
  ...
  { school: 'polyu',
    dirs: ['arts'],
    zh: '人文学院组合课程（文学士）',
    en: 'Bachelor\'s Degree Scheme in Humanities',
    degree: 'JS3007 · 4 年制',
    alevel: '3 AL ≥ B',
    ib: '文凭（典型 ≥32）',
    alevelNote: '国际生档要求',
    test: '面试（入围）',
    offer: 'ger',
    note: '人文学院组合课程（人文學科組合學士課程）；首年共同课程，年末按入学成绩、Year 1 GPA 及面试分流至 4 个主修：中国历史及文化、英文及应用语言学、语言科学与技术、言语治疗',
    url: 'https://www.polyu.edu.hk/study/ug/international/2026/js3007' },

  { school: 'polyu',
    dirs: ['bio'],
    zh: '言语治疗（荣誉）理学士',
    en: 'BSc (Hons) in Speech Therapy',
    degree: 'JS3242 · 4 年制',
    alevel: '3 AL ≥ B',
    ib: '文凭（典型 ≥32）',
    alevelNote: '国际生档要求',
    test: '面试（入围）',
    offer: 'ger',
    note: '人文学院语言科学及科技学系开设；含 27 学分临床教育（临床实习）；入围申请人须面试以评估沟通及语言能力',
    url: 'https://www.polyu.edu.hk/study/ug/international/2026/js3242' },

  { school: 'polyu',
    dirs: ['arts'],
    zh: '时装（荣誉）文学士组合课程',
    en: 'BA (Hons) Scheme in Fashion',
    degree: 'JS3050 · 4 年制',
    alevel: '3 AL ≥ B',
    ib: '文凭（典型 ≥32）',
    alevelNote: '国际生档要求',
    test: '面试（入围）',
    offer: 'ger',
    note: '时装及纺织学院组合课程；首年为共同课程，主修：时装设计、针织时装设计、内衣及运动服装、时装商务、时装创新及科技；艺术科目成绩较佳者优先',
    qs: ['art-design'],
    url: 'https://www.polyu.edu.hk/study/ug/international/2026/js3050' },
  ...
  // ── 社科 / 教育方向补充（2026-09-11 采集）──
  { school: 'hkbu',
    dirs: ['social'],
    zh: '文学士／社会科学学士（荣誉）（欧洲研究[法/德组]／地理／全球及中国研究／政治及国际关系／历史／社会学）',
    en: 'BA (Hons) / BSocSc (Hons) (European Studies / Geography / Global and China Studies / Government and International Studies / History / Sociology)',
    degree: 'JS2610 · 4 年制',
    alevel: '3 AL ≥ E',
    ib: '文凭（2025 录取 30–35）',
    alevelNote: '',
    test: '',
    offer: 'ger',
    note: '文学院与社会科学院联合招生；首年后经内部申请选主修：欧洲研究（法/德组）、地理、全球及中国研究、政治及国际关系、历史、社会学',
    url: 'https://admissions.hkbu.edu.hk/programmes/faculty-of-arts-and-social-sciences/bachelor-of-arts-hons-bachelor-of-social-sciences-hons-european-studies-french-german-stream-geography-global-and-china-studies-government-and-international-studies-history-sociology-year1.html' },

  { school: 'hkbu',
    dirs: ['social'],
    zh: '社会工作学士（荣誉）',
    en: 'Bachelor of Social Work (Hons)',
    degree: 'JS2660 · 4 年制',
    alevel: '3 AL ≥ E',
    ib: '文凭（2025 录取 30–35）',
    alevelNote: '',
    test: '面试（入围）',
    offer: 'ger',
    note: '社会工作学系；四年制专业社工训练，毕业可向香港社会工作者注册局注册为注册社工（RSW）；具英语及中文以外语言能力（如乌尔都语、尼泊尔语、印地语）者或获邀面试',
    url: 'https://admissions.hkbu.edu.hk/programmes/faculty-of-arts-and-social-sciences/bachelor-of-social-work-hons-year1.html' },

  { school: 'hkbu',
    dirs: ['arts', 'social'],
    zh: '宗教、哲学及伦理学文学士（荣誉）',
    en: 'BA (Hons) in Religion, Philosophy and Ethics',
    degree: 'JS2025 · 4 年制',
    alevel: '3 AL ≥ E',
    ib: '文凭（2025 录取 30–35）',
    alevelNote: '',
    test: '',
    offer: 'ger',
    note: '跨学科课程，系统研习世界主要宗教、哲学传统与伦理学派，并结合当代社会文化议题（生命与死亡、性别平等、社会公义等）',
    url: 'https://admissions.hkbu.edu.hk/programmes/faculty-of-arts-and-social-sciences/bachelor-of-arts-hons-in-religion-philosophy-and-ethics-year1.html' },

  { school: 'hkbu',
    dirs: ['social', 'edu'],
    zh: '体育及康乐管理文学士（荣誉）',
    en: 'BA (Hons) in Physical Education and Recreation Management',
    degree: 'JS2620 · 4 年制',
    alevel: '3 AL ≥ E',
    ib: '文凭（2025 录取 30–35）',
    alevelNote: '',
    test: '',
    offer: 'ger',
    note: '体育、运动及康乐管理方向；申请人须提交国际体育比赛或运动相关活动的成就证书／证明',
    url: 'https://admissions.hkbu.edu.hk/programmes/faculty-of-arts-and-social-sciences/bachelor-of-arts-hons-in-physical-education-and-recreation-management-year1.html' },

  { school: 'hkbu',
    dirs: ['arts', 'media'],
    zh: '数码未来与人文学文理学士（荣誉）',
    en: 'BASc (Hons) in Digital Futures and Humanities',
    degree: 'JS2960 · 4 年制',
    alevel: '3 AL ≥ E',
    ib: '文凭（2025 录取 30–35）',
    alevelNote: '',
    test: '面试（入围）',
    offer: 'ger',
    note: '跨学科文理学士，结合人文学与数码科技，涵盖数码文化资源管理、创新政策、数码转型；申请人或获邀面试，并可提交个人档案',
    url: 'https://admissions.hkbu.edu.hk/programmes/faculty-of-arts-and-social-sciences/bachelor-of-arts-and-science-hons-in-digital-futures-and-humanities-year1.html' },

  { school: 'hkbu',
    dirs: ['social', 'bio'],
    zh: '健康及社会福祉创新社会科学学士／理学士（荣誉）',
    en: 'BSocSc (Hons) / BSc (Hons) in Innovation in Health and Social Well-Being',
    degree: 'JS2940 · 4 年制',
    alevel: '3 AL ≥ E',
    ib: '文凭（2025 录取 30–35）',
    alevelNote: '',
    test: '',
    offer: 'ger',
    note: '跨学科课程，设健康及社会福祉、健康科技与信息学两个方向，结合科技与健康／社会领域知识',
    url: 'https://admissions.hkbu.edu.hk/programmes/faculty-of-arts-and-social-sciences/bachelor-of-social-sciences-hons-bachelor-of-science-hons-in-innovation-in-health-and-social-well-being-year1.html' },
  ...
  { school: 'eduhk',
    dirs: ['arts', 'edu'],
    zh: '创意与数码艺术文学士及音乐教育学士（双学位）',
    en: 'BA (Hons) in Creative and Digital Arts & BEd (Hons) (Music)',
    degree: 'JS8001 · 5 年制',
    alevel: '3 AL ≥ D',
    ib: '文凭（平均录取 30/45）',
    alevelNote: '5 年制双学位',
    test: '面试（入围）',
    offer: 'ger',
    note: '音乐教育师资路线，涵盖西方与中国音乐及 STEAM 音乐教育；对应视觉艺术教育的双学位版本为 JS8002',
    url: 'https://www.apply.eduhk.hk/ug/programmes/ba_bed_mu' },

  { school: 'eduhk',
    dirs: ['arts', 'edu'],
    zh: '文化遗产教育与艺术管理文学士（荣誉）',
    en: 'BA (Hons) in Heritage Education and Arts Management',
    degree: 'JS8687 · 4 年制',
    alevel: '3 AL ≥ D',
    ib: '文凭（平均录取 30/45）',
    alevelNote: '',
    test: '面试（入围）',
    offer: 'ger',
    note: '面向艺术、文化、遗产与博物馆教育；与本地及国家遗产和艺术机构合作，设高级学年（2 年）入学及双学位版本（JS8005）',
    url: 'https://www.apply.eduhk.hk/ug/programmes/heam' },

  { school: 'eduhk',
    dirs: ['arts', 'media'],
    zh: '数码中国文化与传意文学士（荣誉）',
    en: 'BA (Hons) in Digital Chinese Culture and Communication',
    degree: 'JS8674 · 4 年制',
    alevel: '3 AL ≥ D',
    ib: '文凭（平均录取 30/45）',
    alevelNote: '',
    test: '面试（入围）',
    offer: 'ger',
    note: '结合中文语言文化与媒体、创意艺术及数码素养，面向创意产业、旅游、零售及知识产权服务；另设双学位版本（JS8003）',
    url: 'https://www.apply.eduhk.hk/ug/programmes/dccc' },

  { school: 'eduhk',
    dirs: ['arts', 'media'],
    zh: '英语研究与数码传意文学士（荣誉）',
    en: 'BA (Hons) in English Studies and Digital Communication',
    degree: 'JS8675 · 4 年制',
    alevel: '3 AL ≥ D',
    ib: '文凭（平均录取 30/45）',
    alevelNote: '',
    test: '面试（入围）',
    offer: 'ger',
    note: '英语语言、语言学与数码素养并重，训练以数码工具进行语言教学、内容创作与出版；另设双学位版本（JS8004）',
    url: 'https://www.apply.eduhk.hk/ug/programmes/esdc' },

  { school: 'eduhk',
    dirs: ['arts'],
    zh: '创意与数码艺术文学士（荣誉）（音乐／视觉艺术）',
    en: 'BA (Hons) in Creative and Digital Arts',
    degree: 'JS8685 / JS8686 · 4 年制',
    alevel: '3 AL ≥ D',
    ib: '文凭（平均录取 30/45）',
    alevelNote: '',
    test: '面试（入围）',
    offer: 'ger',
    note: 'JS8685 为音乐组、JS8686 为视觉艺术组；面向艺术科技、娱乐及多媒体领域，设实习；另设双学位版本（JS8001／JS8002）',
    url: 'https://www.apply.eduhk.hk/ug/programmes/bacda' },
  ...
  { school: 'lingnan',
    ...
    test: '',
    offer: 'ger',
    note: '社会科学学院社会学及社会政策系；可选「社会创新与社会研究」专修',
    url: 'https://www.ln.edu.hk/admissions/ug/programme/overseas-and-mainland-applicants-holding-international-qualifications/sociology' },

  { school: 'lingnan',
    dirs: ['social'],
    zh: '社会及公共政策研究（社会科学荣誉学士）',
    en: 'BSocSc (Hons) — Social and Public Policy Studies',
    degree: 'JS7306 · 4 年制',
    alevel: '3 AL 合格',
    ib: '文凭（官网未列分数）',
    alevelNote: '',
    test: '',
    offer: 'ger',
    note: '由经济系与社会学及社会政策系合办；可选「智慧城市与数码社会」专修',
    url: 'https://www.ln.edu.hk/admissions/ug/programme/overseas-and-mainland-applicants-holding-international-qualifications/social-and-public-policy-studies' },

  { school: 'lingnan',
    dirs: ['arts', 'media'],
    zh: '文化研究（荣誉文学士）',
    en: 'BA (Hons) in Cultural Studies',
    degree: 'JS7606 · 4 年制',
    alevel: '3 AL 合格',
    ib: '文凭（官网未列分数）',
    alevelNote: '',
    test: '',
    offer: 'ger',
    note: '文学院；跨学科，着重批判写作与媒体素养，可选「数码文化与媒体实践／文化公地」「社会创新与创意」等专修',
    url: 'https://www.ln.edu.hk/admissions/ug/programme/overseas-and-mainland-applicants-holding-international-qualifications/cultural-studies' },

  { school: 'lingnan',
    dirs: ['arts'],
    zh: '历史（荣誉文学士）',
    en: 'BA (Hons) in History',
    degree: 'JS7709 · 4 年制',
    alevel: '3 AL 合格',
    ib: '文凭（官网未列分数）',
    alevelNote: '',
    test: '',
    offer: 'ger',
    note: '历史系；可选「亚洲史／全球史」专修',
    url: 'https://www.ln.edu.hk/admissions/ug/programme/overseas-and-mainland-applicants-holding-international-qualifications/history' },

  { school: 'lingnan',
    dirs: ['arts'],
    zh: '哲学（荣誉文学士）',
    en: 'BA (Hons) in Philosophy',
    degree: 'JS7802 · 4 年制',
    alevel: '3 AL 合格',
    ib: '文凭（官网未列分数）',
    alevelNote: '',
    test: '',
    offer: 'ger',
    note: '哲学系；着重理解与构建哲学论证，兼及分析思维、沟通与写作训练，涵盖东西方思想',
    url: 'https://www.ln.edu.hk/admissions/ug/programme/overseas-and-mainland-applicants-holding-international-qualifications/philosophy' },

  { school: 'lingnan',
    dirs: ['arts', 'media'],
    zh: '电影与视觉艺术（荣誉文学士）',
    en: 'BA (Hons) in Film and Visual Art',
    degree: 'JS7905 · 4 年制',
    alevel: '3 AL 合格',
    ib: '文凭（官网未列分数）',
    alevelNote: '',
    test: '',
    offer: 'ger',
    note: '数码艺术与创意产业系（DACI）；涵盖影视、动画、博物馆与策展、艺术史及数码艺术与沉浸式媒体',
    url: 'https://www.ln.edu.hk/admissions/ug/programme/overseas-and-mainland-applicants-holding-international-qualifications/film-and-visual-arts' },
