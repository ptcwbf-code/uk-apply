...
const HKSCHOOLS = [
  { key: 'hku',    zh: '港大',   en: 'University of Hong Kong',        group: '港八', color: '#25603c' },
  { key: 'cuhk',   zh: '港中文', en: 'Chinese University of Hong Kong', group: '港八', color: '#6c3a74' },
  { key: 'hkust',  zh: '港科大', en: 'Hong Kong University of Science & Tech', group: '港八', color: '#1f5aa8' },
  { key: 'cityu',  zh: '城大',   en: 'City University of Hong Kong',    group: '港八', color: '#b02a30' },
  { key: 'polyu',  zh: '理大',   en: 'Hong Kong Polytechnic University', group: '港八', color: '#9b2f5f' },
  { key: 'hkbu',   zh: '浸会',   en: 'Hong Kong Baptist University',   group: '港八', color: '#a15c11' },
  { key: 'eduhk',  zh: '教育',   en: 'Education University of Hong Kong', group: '港八', color: '#0f7a6c' },
  { key: 'lingnan', zh: '岭南',  en: 'Lingnan University',             group: '港八', color: '#8c1d40' }
];
