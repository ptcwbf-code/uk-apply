...
// ── LSE · 社科核心（LSE 本就是社科专门院校；法学 LNAT，其余无笔试、无面试） ──
  ...
  { school: 'edinburgh',
    ...
    alevel: 'ABB',
    ib: '34（HL655）',
    alevelNote: '无指定 A-level 科目；GCSE 英语语言 C/4、英语文学 C/4、数学 C/4；另需苏格兰盖尔语（SQA Higher Scottish Gàidhlig B 或 National 5 A）；IB 须含 HL English Language and Literature 5，补数学 SL 4',
    test: '',
    offer: 'range',
    note: 'UCAS 3T59；Moray House 教育与体育学院；4 年制，培养以盖尔语授课的小学教师，含必修学校教学实习；须面试并符合教师 fitness to practise 要求',
    url: 'https://study.ed.ac.uk/programmes/undergraduate/628-primary-education-with-gaelic-fluent-speakers' },
